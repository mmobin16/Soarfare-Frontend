        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <h2 className="text-3xl md:text-3xl font-bold text-primary-foreground">
                Still need to ask something?
              </h2>
            </div>
           <div className="flex flex-col gap-3 min-w-fit">
  <p className="text-white font-normal text-sm tracking-wide text-right">
  Ask away – we’re ready to help you<br /> book your journey.
</p>

          ...
          <div className="order-1 lg:order-1 relative flex justify-center lg:justify-end">
            ...
            <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
              ...
              <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 md:-top-5 md:-right-5 lg:-top-6 lg:-right-6 z-0">
                <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-white rounded-full shadow-md flex items-center justify-center p-1.5 sm:p-2 md:p-2.5">
                  <img 
                    src="/statpng.png" 
                    alt="Custom Icon" 

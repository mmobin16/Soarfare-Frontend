      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-primary-foreground font-semibold text-lg mb-4 sm:mb-6">Quick Links</h4>
          ...
          {/* Info */}
          <div className="text-center sm:text-left">
            <h4 className="text-primary-foreground font-semibold text-lg mb-4 sm:mb-6">Info</h4>
            <ul className="space-y-2 sm:space-y-3">
          ...
          {/* Official Info */}
          <div className="sm:col-span-2 lg:col-span-1">
            <h4 className="text-primary-foreground font-semibold text-lg mb-4 sm:mb-6 text-center sm:text-left">Official Info</h4>
